...
+ (SVGCurve) readMovetoDrawtoCommandGroups:(NSScanner*)scanner path:(CGMutablePathRef)path relativeTo:(CGPoint)origin isRelative:(BOOL) isRelative
{
	...
	SVGKitLogError("Parsing command string: move-to, draw-to command");
#endif
...
+ (SVGCurve) readMovetoArgumentSequence:(NSScanner*)scanner path:(CGMutablePathRef)path relativeTo:(CGPoint)origin isRelative:(BOOL) isRelative
{
	...
	SVGKitLogError("[%@] PATH: MOVED to %2.2f, %2.2f", [SVGKPointsAndPathsParser class], coord.x, coord.y );
#endif
...
{
#if VERBOSE_PARSE_SVG_COMMAND_STRINGS
	SVGKitLogError("Parsing command string: line-to command");
#endif
...
#if DEBUG_PATH_CREATION
	SVGKitLogError("[%@] PATH: LINE to %2.2f, %2.2f", [SVGKPointsAndPathsParser class], coord.x, coord.y );
#endif
...
{
#if VERBOSE_PARSE_SVG_COMMAND_STRINGS
	SVGKitLogError("Parsing command string: quadratic-bezier-curve-to command");
#endif
...
#if DEBUG_PATH_CREATION
	SVGKitLogError("[%@] PATH: QUADRATIC CURVE to (%2.2f, %2.2f)..(%2.2f, %2.2f)", [SVGKPointsAndPathsParser class], curveResult.c1.x, curveResult.c1.y, curveResult.p.x, curveResult.p.y);
#endif
...
{
#if VERBOSE_PARSE_SVG_COMMAND_STRINGS
	SVGKitLogError("Parsing command string: smooth-quadratic-bezier-curve-to command");
#endif
	NSString* cmd = nil;
...
#if DEBUG_PATH_CREATION
	SVGKitLogError("[%@] PATH: SMOOTH QUADRATIC CURVE to (%2.2f, %2.2f)..(%2.2f, %2.2f)", [SVGKPointsAndPathsParser class], thisCurve.c1.x, thisCurve.c1.y, thisCurve.p.x, thisCurve.p.y );
#endif
...
{
#if VERBOSE_PARSE_SVG_COMMAND_STRINGS
	SVGKitLogError("Parsing command string: curve-to command");
#endif
    NSString* cmd = nil;
...
#if DEBUG_PATH_CREATION
	SVGKitLogError("[%@] PATH: CURVE to (%2.2f, %2.2f)..(%2.2f, %2.2f)..(%2.2f, %2.2f)", [SVGKPointsAndPathsParser class], curveResult.c1.x, curveResult.c1.y, curveResult.c2.x, curveResult.c2.y, curveResult.p.x, curveResult.p.y);
#endif
...
#if DEBUG_PATH_CREATION
	SVGKitLogError("[%@] PATH: SMOOTH CURVE to (%2.2f, %2.2f)..(%2.2f, %2.2f)..(%2.2f, %2.2f)", [SVGKPointsAndPathsParser class], thisCurve.c1.x, thisCurve.c1.y, thisCurve.c2.x, thisCurve.c2.y, thisCurve.p.x, thisCurve.p.y );
#endif
...
#if DEBUG_PATH_CREATION
    SVGKitLogError("[%@] PATH: VERTICAL LINE to (%2.2f, %2.2f)", [SVGKPointsAndPathsParser class], coord.x, coord.y );
#endif
    CGPathAddLineToPoint(path, NULL, coord.x, coord.y);
...
{
#if VERBOSE_PARSE_SVG_COMMAND_STRINGS
	SVGKitLogError("Parsing command string: vertical-line-to command");
#endif
    NSString* cmd = nil;
...
#if DEBUG_PATH_CREATION
    SVGKitLogError("[%@] PATH: HORIZONTAL LINE to (%2.2f, %2.2f)", [SVGKPointsAndPathsParser class], coord.x, coord.y );
#endif
    CGPathAddLineToPoint(path, NULL, coord.x, coord.y);
...
{
#if VERBOSE_PARSE_SVG_COMMAND_STRINGS
	SVGKitLogError("Parsing command string: horizontal-line-to command");
#endif
    NSString* cmd = nil;
...
{
#if VERBOSE_PARSE_SVG_COMMAND_STRINGS
	SVGKitLogError("Parsing command string: close command");
#endif
    NSString* cmd = nil;
...
#if DEBUG_PATH_CREATION
	SVGKitLogError("[%@] PATH: finished path", [SVGKPointsAndPathsParser class] );
#endif
