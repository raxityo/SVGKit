...
{
	SVGKitLogError("[%@] SVG WARNING: %@", [self class], warning);
	[self.warnings addObject:warning];
}

-(void) addParseErrorRecoverable:(NSError*) recoverableError
{
	SVGKitLogError("[%@] SVG WARNING (recoverable): %@", [self class], recoverableError);
...
{
	SVGKitLogError("[%@] SVG ERROR: %@", [self class], [saxError localizedDescription]);
