...
#define SVGKitLog                   os_log_create("com.svgkit.svgkit", "SVGKit")
#define SVGKitLogError(frmt, ...)   os_log_with_type(SVGKitLog, OS_LOG_TYPE_FAULT, frmt, ##__VA_ARGS__);
#define SVGKitLogWarn(frmt, ...)    os_log_with_type(SVGKitLog, OS_LOG_TYPE_ERROR, frmt, ##__VA_ARGS__);
#define SVGKitLogInfo(frmt, ...)    os_log_with_type(SVGKitLog, OS_LOG_TYPE_INFO, frmt, ##__VA_ARGS__);
#define SVGKitLogVerbose(frmt, ...) os_log_with_type(SVGKitLog, OS_LOG_TYPE_DEBUG, frmt, ##__VA_ARGS__);
